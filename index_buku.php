...
if(isset($_POST['tombol_search'])){
    ...
    $query_count = "SELECT COUNT(*) as total FROM buku b 
                    LEFT JOIN kategori k ON b.id_kategori = k.id 
                    WHERE b.judul LIKE '%$keyword%' OR b.penulis LIKE '%$keyword%' OR b.penerbit LIKE '%$keyword%'";
    $query_data = "SELECT b.*, k.nama_kategori FROM buku b 
                   LEFT JOIN kategori k ON b.id_kategori = k.id 
                   WHERE b.judul LIKE '%$keyword%' OR b.penulis LIKE '%$keyword%' OR b.penerbit LIKE '%$keyword%'
                   ORDER BY b.tanggal_input DESC LIMIT $start, $limit";
} else {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="index_buku.php">
                            <i class="bi bi-book"></i> Data Buku
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_kategori.php">
    ...
    <section class="py-4">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="bi bi-book-fill text-primary"></i> Data Buku</h2>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <form action="" method="POST" class="d-flex">
                    <input type="text" class="form-control me-2" name="keyword" placeholder="Cari buku..." autocomplete="off" style="width: 300px;" value="<?= isset($_POST['keyword']) ? htmlspecialchars($_POST['keyword']) : '' ?>">
                    <button class="btn btn-outline-primary" type="submit" name="tombol_search">
                        <i class="bi bi-search"></i> Cari
                    </button>
                    <?php if(isset($_POST['tombol_search'])): ?>
                    <a href="index_buku.php" class="btn btn-outline-secondary ms-2">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ubah_buku.php?id=<?= $data['id'] ?>" class="btn btn-sm btn-warning mb-1">
